  ...
  return (
    <div className="bg-surface-container-lowest rounded-[24px] p-16 flex flex-col items-center justify-center text-center shadow-[0_20px_50px_-12px_rgba(25,28,30,0.04)] border border-white/50">
      ...
      <button
        ...
        className="mt-8 px-6 py-2.5 bg-secondary-container text-on-secondary-container font-bold rounded-xl text-sm transition-all hover:bg-secondary-fixed active:scale-95"
      >
        Clear Filters
      </button>
    </div>
